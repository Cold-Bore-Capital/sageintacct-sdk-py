...
from .apis import ApiBase, Contacts, Locations, Employees, Accounts, ExpenseTypes, Attachments, ExpenseReports,\
    ...
    DimensionValues, LocationEntities, ARInvoices, TaxDetails, GLDetail, Classes, CustomerTypes, Invoices, ARAdjustment, ReadReport, UpdateInvoices, UpdateCustomers
...
class SageIntacctSDK:
    ...
    def __init__(self, sender_id: str, sender_password: str, user_id: str,
        ...
        self.update_customers = UpdateCustomers()
    ...
    def update_sender_id(self):
        ...
        self.customer_types.set_sender_id(self.__sender_id)
        self.items.set_sender_id(self.__sender_id)
        self.invoices.set_sender_id(self.__sender_id)
        self.ap_payments.set_sender_id(self.__sender_id)
        self.ar_invoices.set_sender_id(self.__sender_id)
        self.ar_adjustment.set_sender_id(self.__sender_id)
        ...
        self.read_report.set_sender_id(self.__sender_id)
        self.update_invoices.set_sender_id(self.__sender_id)
        self.update_customers.set_sender_id(self.__sender_id)
    ...
    def update_sender_password(self):
        ...
        self.customer_types.set_sender_password(self.__sender_password)
        self.items.set_sender_password(self.__sender_password)
        self.invoices.set_sender_password(self.__sender_password)
        self.ap_payments.set_sender_password(self.__sender_password)
        self.ar_invoices.set_sender_password(self.__sender_password)
        self.ar_adjustment.set_sender_password(self.__sender_password)
        ...
        self.read_report.set_sender_password(self.__sender_password)
        self.update_invoices.set_sender_password(self.__sender_password)
        self.update_customers.set_sender_password(self.__sender_password)
    ...
    def update_session_id(self):
        ...
        self.customer_types.set_session_id(self.__session_id)
        self.items.set_session_id(self.__session_id)
        self.invoices.set_session_id(self.__session_id)
        self.ap_payments.set_session_id(self.__session_id)
        self.ar_invoices.set_session_id(self.__session_id)
        self.ar_adjustment.set_session_id(self.__session_id)
        ...
        self.read_report.set_session_id(self.__session_id)
        self.update_invoices.set_session_id(self.__session_id)
        self.update_customers.set_session_id(self.__session_id)